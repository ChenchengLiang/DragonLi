...
For our `DragonLi` and `Z3`, the difficulties of these benchmarks are proportional to the total variable occurrence ratio and the length of the equations, as an increase in these values leads to a decrease in the number of solved problems, as shown in **Table 2** in the paper.
