...
def main():
    ...
    train_step=10
    configurations = []
    for benchmark in ["rank_01_track_multi_word_equations_generated_train_1_40000_new_divided_100_chunk_size_multiple_path"]:#["01_track_multi_word_equations_generated_train_1_40000_new_SAT_divided_1"]:
