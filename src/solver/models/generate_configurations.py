...
def main():
    ...
    train_step=10
    configurations = []
    for benchmark in ["01_track_multi_word_equations_generated_train_1_40000_new_small_test/divided_1"]:#["01_track_multi_word_equations_generated_train_1_40000_new_SAT_divided_1"]:
