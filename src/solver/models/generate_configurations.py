...
def main():
    ...
    #for benchmark in ["01_track_multi_word_equations_generated_train_1_40000_for_rank_task_UNSAT_data_extraction_shortest_path_40000_chunk_size_5000_rank_task_0"]:
