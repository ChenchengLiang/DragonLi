...
def main():
    ...
    benchmark="test_track_task_1"#"01_track_generated_SAT_train"
    algorithm_parameters = {"branch_method": "extract_branching_data_task_1","extract_algorithm":"fixed"} #extract_branching_data_task_2
