...
def main():
    directory_path = bench_folder + '/kaluzaWoorpje/eq_cleaned'


    target_content = "Variables {}\nTerminals {}\nSatGlucose(0)"  # no variables
    empty_file_list = delete_files_with_content(directory_path, target_content,log=False)


    duplicated_files_list = delete_duplicate_files(directory_path,log=False)
