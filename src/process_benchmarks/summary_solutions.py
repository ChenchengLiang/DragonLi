...
def main():
    ...
    main_key = "this:fixed_termination_condition_0_hybrid_category_fixed_random"#"this:fixed_termination_condition_0_category"# empty will output all pair combinations
        ...
        for f in glob.glob(project_folder+"/src/process_benchmarks/summary/to_summary/*.csv"):
            if track in f:
                ...
                if solver == "this":
                    ...
                    summary_file_dict[solver] = solver + "_" + track + "_summary.csv"
                    # if parameter_str=="":
                    #     summary_file_dict[
