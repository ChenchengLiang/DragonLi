...
def main():
    ...
    solver_param_list = [
        ...
        #   f"--gnn_task {task}"]],
        # ["this",
        #  ["gnn:random", f"--termination_condition execute_termination_condition_1", "--graph_type graph_2", "--gnn_model_path " + model_folder + "model_0_graph_2_GCNSplit.pth",
        #   f"--gnn_task {task}"]],
        # ["this",
        #  ["gnn:random", f"--termination_condition execute_termination_condition_2", "--graph_type graph_2", "--gnn_model_path " + model_folder + "model_0_graph_2_GCNSplit.pth",
        #   f"--gnn_task {task}"]],
        #
        # ["this",
        #  ["gnn:fixed", f"--termination_condition execute_termination_condition_0", "--graph_type graph_2", "--gnn_model_path " + model_folder + "model_0_graph_2_GCNSplit.pth",
        #   f"--gnn_task {task}"]],
        # ["this",
        #  ["gnn:fixed", f"--termination_condition execute_termination_condition_1", "--graph_type graph_2", "--gnn_model_path " + model_folder + "model_0_graph_2_GCNSplit.pth",
        #   f"--gnn_task {task}"]],
        # ["this",
    ...
    benchmark_name = "04_track_generated_train_1_1000"
